      ...
      <div class="content-box-content">    
        <div class="tab-content default-tab" id="tab2">
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <p>
              <label>标题</label>
              <input class="text-input small-input" type="text"  name="title" value="<?php echo ($arr["title"]); ?>" />
            </p>  
           <p>
              <label>作者</label>
              <input class="text-input small-input" type="text"  name="author" value="<?php echo ($arr["author"]); ?>"  />
            </p>  
            <p>
              <label>分类</label>
             ...
             <p>
              <label>内容来源</label>
              <input class="text-input small-input" type="text"  name="content_source" value="<?php echo ($arr["content_source"]); ?>" />
            </p> 
            <p>
              <label>图片来源</label>
              <input class="text-input small-input" type="text"  name="des_source" value="<?php echo ($arr["des_source"]); ?>" />
            </p> 
             <p>
              <label>新闻简介</label>
            ...
            <div>
              ...
              <ul class="images_list">
                 <li>
	              <img alt="上传图片" src="/think/<?php echo ($arr["images"]); ?>" class="img" >
    	 ...
    	 var file = this.files[0]; //监听其中的一张图
    	   if (window.FileReader) {    
    	          ...
    	          reader.onloadend = function (e) {
    	                  ...
    	                  str+='<div><img src="/think/fancy_close.png" class="delete" /></div>';
    	                  str+='</li>';
