        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                ...
                <td><img  src='/think/<?php echo json_decode($v["thumb_img"])[0];?>'  alt="品牌图片" ></td>
                <td><?php echo ($v["time"]); ?></td>
                <td>
                  <!-- Icons -->
                  <a href="<?php echo U('Brandintroduction/update',array('id'=>$v['id'],'p'=>$p));?>" title="Edit">
                  <img src="resources/images/icons/pencil.png" alt="Edit" /></a> 
                  <a href="<?php echo U('Brandintroduction/delete',array('id'=>$v['id'],'p'=>$p));?>" title="Delete">
                  <img src="resources/images/icons/cross.png" alt="Delete" /></a> 
                  <a href="<?php echo U('Brandintroduction/insert',array('id'=>$v['id'],'p'=>$p));?>" title="Edit Meta">
