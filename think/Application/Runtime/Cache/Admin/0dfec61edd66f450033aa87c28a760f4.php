...
<link rel="stylesheet" href="/think/valite/css/style.css" type="text/css" />
    ...
    <div id="login-content">
      <form action="" method="post" class="message" >
        ...
        <p>
            ...
            <input class="text-input" type="text"  name="names" datatype="*3-14" nullmsg="用户名不能为空" errormsg="用户名长度为3-14位"  />
           
        </p>
        <div class="clear"></div>
        <p>
            <label>Password</label>
            <input class="text-input" type="password" name="password" datatype="*5-12" nullmsg="密码不能为空" errormsg="长度大于等于5小于等于12" />
            
        </p>
        <div class="clear"></div>
        <p>
			<label>验证码</label>
			<input class="text-input" type="text" name="code"   datatype="*" nullmsg="验证码为空"  ajaxurl="<?php echo U('Public/vcode');?>" />
		</p>
		<div class="clear"></div>
		<p>
			<a>请输入图中字符，不区分大小写</a>
        ...
        <p><a href="<?php echo U('Login/getpassword');?>">忘记密码</a></p>
      </form>
    </div>
  <!-- End #login-content -->
</div>
