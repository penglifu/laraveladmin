        ...
        <div class="tab-content default-tab" id="tab2">
          <form action="" method="post" enctype="multipart/form-data">
           ...
           <style>
            ...
            <p>
              <label>图片</label>
              <span><img  src='/think/<?php echo ($arr["images"]); ?>'  alt="产品" class="img" ></span>
            </p>  
            <p>
              <label>用户名</label>
              <input class="text-input small-input" type="text"   value="<?php echo ($arr["username"]); ?>"  readonly="readonly"/>
            </p>  
            <p>
              <label>留言</label>
              <input class="text-input small-input" type="text"    value="<?php echo ($arr["maseege"]); ?>"  readonly="readonly"/>
            </p> 
            <p>
              <label>订单号</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["ordernum"]); ?>"  readonly="readonly"/>
            </p> 
             <p>
              <label>数量</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["number"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>卖家促销</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["chuxiao"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>店铺优惠</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["discount"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>配送</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["peishong"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>单价</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["promotion_price"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>产品简介</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["des"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>姓名</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["name"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>号码</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["phone"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>地址</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["address"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>时间</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["time1"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>付款状态</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["zhihu"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>发货状态</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["fahuo"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>收货状态</label>
              <input class="text-input small-input" type="text"     value="<?php echo ($arr["shouhuo"]); ?>"  readonly="readonly"/>
            </p>
            </fieldset>
            <div class="clear"></div>
            <!-- End .clear -->
