      ...
      <div class="content-box-content">    
        <div class="tab-content default-tab" id="tab2">
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <p>
              <label>标题</label>
              <input class="text-input small-input" type="text"  name="title" value="<?php echo ($arr["title"]); ?>" readonly="readonly" />
            </p>  
            <p>
              <label>用户名</label>
            ...
            <p>
             ...
             <p>
              <label>留言内容</label>
              <textarea rows="2" cols="1" name="content"  readonly="readonly" ><?php echo ($arr["content"]); ?></textarea>
            </p>
