        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                ...
                <td><img  src='/think/<?php echo ($v["thumb_img"]); ?>'  alt="banner图片" ></td>
                <td><?php echo ($v["time"]); ?></td>
                <td>
                  <!-- Icons --> 
                  <a href="<?php echo U('Banner/update',array('id'=>$v['id']));?>" title="Edit">
                  <img src="resources/images/icons/pencil.png" alt="Edit" /></a>
                  <a href="<?php echo U('Banner/delete',array('id'=>$v['id'],'p'=>$p));?>" title="Delete">
