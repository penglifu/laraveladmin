      ...
      <div class="content-box-content">    
        <div class="tab-content default-tab" id="tab2">
          <form action="" method="post" class="message" >
            ...
            <p>
              <label>用户名</label>
              <input class="text-input small-input" type="text"  name="names"  datatype="*" nullmsg="用户名不能为空" ajaxurl="<?php echo U('Messageadmin/insert');?>" />
            </p>  
            <p>
              <label>密码</label>
            ...
            <p>
              <label>email</label>
              <input class="text-input small-input" type="text"  name="email"   datatype="e" nullmsg="email不能为空" errormsg="email不能为空" ajaxurl="<?php echo U('Messageadmin/insert');?>"/>
            </p> 
            <p>
              <label>管理员</label>
              <select name="level">
