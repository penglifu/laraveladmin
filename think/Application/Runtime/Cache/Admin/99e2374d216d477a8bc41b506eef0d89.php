        ...
        <div class="tab-content default-tab" id="tab2">
          <form action="" method="post" enctype="multipart/form-data">
           ...
           <style>
            ...
            <p>
              <label>用户名</label>
              <span><img  src='/think<?php echo ($arr["images"]); ?>'  alt="头像" class="img" ></span>
            </p>  
            <p>
              <label>用户名</label>
              <input class="text-input small-input" type="text"  name="username"   value="<?php echo ($arr["username"]); ?>"  readonly="readonly"/>
            </p>  
            
            <p>
              <label>email</label>
              <input class="text-input small-input" type="text"  name="email"   value="<?php echo ($arr["email"]); ?>"  readonly="readonly"/>
            </p> 
             <p>
              <label>qq</label>
              <input class="text-input small-input" type="text"  name="qq"   value="<?php echo ($arr["qq"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>phone</label>
              <input class="text-input small-input" type="text"  name="phone"   value="<?php echo ($arr["phone"]); ?>"  readonly="readonly"/>
            </p>
            <p>
              <label>sex</label>
              <?php if($arr['sex']==2): ?><input class="text-input small-input" type="text"     value="女"  readonly="readonly"/>
              <?php else: ?> 
               <input class="text-input small-input" type="text"     value="男"  readonly="readonly"/><?php endif; ?>
            </p>
            </fieldset>
            <div class="clear"></div>
            <!-- End .clear -->
