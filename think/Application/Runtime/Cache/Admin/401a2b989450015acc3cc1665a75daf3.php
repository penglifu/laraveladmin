      ...
      <div class="content-box-content">    
        <div class="tab-content default-tab" id="tab2">
         ...
         <?php if(is_array($sidemeun)): foreach($sidemeun as $key=>$v): ?><p class="check">
	           <input class="text-input check1" type="checkbox"   name="level[]" value="<?php echo ($v["id"]); ?>" /><span class="bold" ><?php echo ($v["name"]); ?></span>
	           <br/>
	            <?php if(is_array($v['zi'])): foreach($v['zi'] as $key=>$v1): ?><input class="text-input check2 " type="checkbox"   value="<?php echo ($v1["level"]); ?>" /><?php echo ($v1["name"]); endforeach; endif; ?>
