        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                ...
                <td><img  src='/think/<?php echo json_decode($v["thumb_img"])[0];?>'  alt="产品图片" ></td>
                <td><?php echo ($v["price"]); ?></td>
                <td><?php echo ($v["promotion_price"]); ?></td>
                <td><?php echo ($v["time"]); ?></td>
                <td>
                  <!-- Icons -->
                  <a href="<?php echo U('Product/update',array('id'=>$v['id'],'p'=>$p));?>" title="Edit">
                  <img src="resources/images/icons/pencil.png" alt="Edit" /></a> 
                  <a href="<?php echo U('Product/delete',array('id'=>$v['id'],'p'=>$p));?>" title="Delete">
                  <img src="resources/images/icons/cross.png" alt="Delete" /></a> 
                  <a href="<?php echo U('Product/insert',array('id'=>$v['id'],'p'=>$p));?>" title="Edit Meta">
