        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                ...
                <td><?php echo mb_substr($v['level'],0,30,"utf-8");?></td>
                <td><?php echo ($v["time"]); ?></td>
                <td>
                  <!-- Icons --> 
                  <a href="<?php echo U('Level/update',array('id'=>$v['id']));?>" title="Edit">
                  <img src="resources/images/icons/pencil.png" alt="Edit" /></a> 
                  <a href="<?php echo U('Level/delete',array('id'=>$v['id']));?>" title="Delete">
