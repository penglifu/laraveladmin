      ...
      <div class="content-box-content">    
        <div class="tab-content default-tab" id="tab2">
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <p>
              <label>权限名称</label>
              <input class="text-input small-input" type="text"  name="name" value="<?php echo ($arr["name"]); ?>" />
            </p>  
            <p>
         ...
         <?php if(is_array($sidemeun)): foreach($sidemeun as $key=>$v): ?><p class="check">
              <?php if(in_array($v['level'],$arr['level'])): ?><input class="text-input check1" type="checkbox"  checked="checked"  name="level[]" value="<?php echo ($v["id"]); ?>" /><span class="bold" ><?php echo ($v["name"]); ?></span>
              <?php else: ?>
	           <input class="text-input check1" type="checkbox"   name="level[]" value="<?php echo ($v["id"]); ?>" /><span class="bold" ><?php echo ($v["name"]); ?></span><?php endif; ?> 
	           <br/>
	            <?php if(is_array($v['zi'])): foreach($v['zi'] as $key=>$v1): if(in_array($v1['level'],$arr['level'])): ?><input class="text-input check2 " type="checkbox" checked="checked"  value="<?php echo ($v1["level"]); ?>" /><?php echo ($v1["name"]); ?>
	              <?php else: ?>
	              <input class="text-input check2 " type="checkbox"   value="<?php echo ($v1["level"]); ?>" /><?php echo ($v1["name"]); endif; endforeach; endif; ?>
