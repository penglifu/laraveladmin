...
<div id="body-wrapper">
  ...
  <div id="main-content">
        ...
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
                ...
                <td class="shou"><?php echo ($v["id"]); ?></td>
                <td><?php echo ($v["username"]); ?></td>
                <td><?php echo mb_substr($v['des'],0,10,"utf-8");?></td>
                <td><img  src='/think/<?php echo ($v["images"]); ?>'  alt="产品" class="img" ></td>
                <td><?php echo ($v["zhihu"]); ?></td>
                <td><?php echo ($v["time1"]); ?></td>
                <td class="fahuo"><span>点击发货</span> <a class="huo"><?php echo ($v["fahuo"]); ?></a></td>
                <td>
                  <!-- Icons -->
                  <a href="<?php echo U('Detail/check',array('id'=>$v['id']));?>" title="Edit">
                  <img src="resources/images/icons/pencil.png" alt="Edit" /></a> 
                  <a href="<?php echo U('Detail/delete',array('id'=>$v['id']));?>" title="Delete">
    ...
    $(".fahuo span").click(function(){
  	  
 	   var id=$(this).parent().siblings(".shou").html();
 	   //alert(id);
 	   var url="<?php echo U('Detail/index');?>";
 	   var huo=$(this).siblings(".huo");
 	   var shou="已发货";
 	   $.ajax({
			   //传参类型：input框一般为post
	              type:"post",
