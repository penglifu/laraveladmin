		...
		<div class="content_type_two">
						...
						<div class="sidebar_top">
							...
							<div class="sidebar_list ">
								...
								<ul>
						             ...
						             <li class="list_inthis"><a  class="list_a_inthis">收藏夹</a></li>
								   ...
								   <?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="list_info">
											...
											<div class="list_info_content">
												...
												<div class="content_right">
													<a class="delete de" href="javascript:">删除</a>
		 ...
		 $(function(){
			      function coun(){
			    	...
			    	//循环添加选中的价格累计 
			    	for(i=0;i<length;i++){
			    	count += parseInt($("input[type='checkbox']:checked").eq(i).parent().siblings(".list_info_content").children(".content_mid").children(".curr_price").html());
			    ...
			    $("input[type='checkbox']").click(function(){
			    	...
			    	if(status){
				    	var num=0;
				    	num++;
				    	$("input[type='checkbox']").parent().parent().siblings(".accounts_box").children(".nub").children().html(num);
				    	...
				    	$("input[type='checkbox']").parent().parent().siblings(".accounts_box").children(".nub").children().html(num1);
				    	$(this).parent().siblings().children(".content_mid").children("curr_price").val();	
