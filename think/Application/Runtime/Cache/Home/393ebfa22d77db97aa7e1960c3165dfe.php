				...
				<div class="kongzhi">
					<div class="sidebar">
						<div class="sidebar_top">
							...
							<div class="sidebar_list">
								...
								<ul>
									<?php if(is_array($category)): foreach($category as $key=>$v): if($id == $v['id']): ?><li class="list_inthis"><a href="<?php echo U('News/NewsCenter',array('id'=>$v['id']));?>" class="list_a_inthis"><?php echo ($v["name"]); ?></a></li>
									    <?php else: ?>
					...
					<div class="content_body_right">
						<div class="right_title">
							<span class="titlename">新闻中心</span> 
                            <span class="current_location">当前位置>新闻中心</span> 
                            <span class="clear_float"></span>
						</div>

                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><div class="newscenter_show">
							<div class="newscenter_show_top">
								<div class="img_show">
									<img src="/think/<?php echo ($v["thumb_img"]); ?>" />
								</div>
								<div class="newsconter_content">
									<div class="newscenter_show_title">
										<a class="title" href="<?php echo U('News/NewsCenterDetails',array('id'=>$v['id']));?>"><?php echo ($v["title"]); ?></a>
                                        <span class="date">发布时间：<?php echo ($v["time"]); ?></span><span class="clear_float"></span>
									</div>
									<p><?php echo ($v["des"]); ?></p>
								</div>
								<div class="clear_float"></div>
							</div>
							<div class="newscenter_show_bottom">
								<a href="<?php echo U('News/NewsCenterDetails',array('id'=>$v['id']));?>"><span class="readall">阅读全文</span>
                                <span class="clear_float"></span></a>
							</div>
