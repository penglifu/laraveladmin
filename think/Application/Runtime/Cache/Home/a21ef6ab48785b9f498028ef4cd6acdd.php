				...
				<div class="kongzhi">
					...
					<div class="sidebar">
						<div class="sidebar_top">
							...
							<div class="sidebar_list">
								...
								<ul>
									<?php if(is_array($category)): foreach($category as $key=>$v): if($id == $v['id']): ?><li class="list_inthis"><a href="<?php echo U('BrandIntroduction/BrandIntroduction',array('id'=>$v['id']));?>" class="list_a_inthis"><?php echo ($v["name"]); ?></a></li>
									    <?php else: ?>
									    <li><a href="<?php echo U('BrandIntroduction/BrandIntroduction',array('id'=>$v['id']));?>"><?php echo ($v["name"]); ?></a></li><?php endif; endforeach; endif; ?>
									<span class="clear_float"></span>
								</ul>
							</div>
					...
					<div class="content_body_right">
						<div class="right_title">
							<span class="titlename">品牌介绍</span> <span
								class="current_location">当前位置>品牌介绍</span> <span
								class="clear_float"></span>
						</div>


						<div class="introduces">
							<div class="introduces_img">
								<img src="/think/<?php echo ($list['images'][0]); ?>" />
							</div>
							<p class="introduces_text"><?php echo ($list["contentone"]); ?></p>
							<div class="clear_float"></div>
						</div>

						<div class="introduces">
							<div class="introduces_img">
								<img src="/think/<?php echo ($list['images'][1]); ?>" />
							</div>
							<p class="introduces_text"><?php echo ($list["contenttwo"]); ?></p>
							<div class="clear_float"></div>
						</div>
