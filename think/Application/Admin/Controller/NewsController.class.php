...
class NewsController extends PublicController {
   //定义图片路径：
   public $path= './Uploads/News/';//上传文件的路径文件夹
   ...
   public function index() {
   	...
   	$list = $User->field("news.*,category.name")->join('LEFT JOIN __CATEGORY__ ON __NEWS__.category = __CATEGORY__.id' )->order('time DESC')->limit($Page->firstRow.','.$Page->listRows)->select();
   	$p=I("get.p",1);
