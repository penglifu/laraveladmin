...
public   function vCode($num = 4, $size = 20, $width = 90, $height = 32) {
    session_start();
    if(empty($width)){
    ...
    // 画验证码
    imagefttext($im, $size , 0, 5, $size + 3, $text_color, 'arial.ttf', $code);
 ...
 */
 ...
 public  function thumb($filename,$thumb_img = 'test.jpg'){
 ...
 */
 public  function water($dst_file,$path,$water_file = 'watermark.png'){
    //获取原图
